...
//  Based on pList Parser by Jonty Wareing http://www.jeremyjohnstone.com/
//

include "Headers/STDictionaryProtocol.php";

/* @uses XMLReader */

class STDictionary extends STArray implements STDictionaryProtocol {
